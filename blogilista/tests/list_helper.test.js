...
describe('total likes', () => {
    ...
    test('Total likes of all blogs should equal to 36', () => {
...
describe('Blogger with most blogs', () => {
    test('Blogger name should equal the name returned by topBlogger', () => {
      expect(listHelper.mostBlogs(blogs).author).toEqual("Robert C. Martin");
    })
})

describe('Blogger with most likes', () => {
    test('Blogger name should equal the name returned by mostLikes', () => {
